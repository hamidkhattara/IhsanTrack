 ...
 * /api/donations:
 *   get:
 *     summary: Get all donations (filter by donation_project_id, payment_method)
 *     tags: [Donations]
 *     parameters:
 *       - in: query
 ...
 *           schema:
 *             type: object
 *             required: [donation_project_id, amount, payment_method]
 *             properties:
 *               donation_project_id:
 *                 type: integer
 *                 example: 1
 ...
 *     responses:
 *       201:
 *         description: Donation created and donation project amount updated
 *       400:
 *         description: Donation project has reached its deadline
 *       404:
